...
const WAVEFORM_HEIGHTS = [
  0.35, 0.6, 0.4, 0.8, 0.5, 0.9, 0.45, 0.65, 0.3, 0.75, 0.5, 0.85, 0.4, 0.6,
  0.9, 0.35, 0.7, 0.5, 0.8, 0.45, 0.65, 0.55, 0.4, 0.75,
];
...
export function AudioRecorder({
  ...
  return (
    <div className="flex flex-col items-center gap-6 p-6 min-h-screen justify-center">
      ...
      <p className="text-(--color-on-surface-variant) text-sm -mt-4">
        Maks {MAX_AUDIO_SECONDS} detik
      </p>
